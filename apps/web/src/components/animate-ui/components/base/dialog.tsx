  ...
  return (
    <DialogPortalPrimitive>
      ...
      <DialogPopupPrimitive
        className={cn(
          // Both mobile and desktop: flex col, children control their own scroll
          'bg-background fixed inset-0 z-50 flex flex-col',
          // sm+: centred modal with max height
          'sm:inset-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2',
          'sm:w-full sm:max-w-lg sm:max-h-[90dvh] sm:border sm:shadow-lg',
          className,
        )}
        {...props}
      >
