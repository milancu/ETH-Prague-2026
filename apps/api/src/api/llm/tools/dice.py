...
async def reveal_dice_market(
    ...
    # The on-chain market is authoritative; we don't need a Market row in our
    # DB to reveal. If the BE sync (apps/web -> /markets) failed, reveal still
    # works because resolveMarket only needs market_id + target_sequence.
